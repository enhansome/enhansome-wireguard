...
* [WireGuard Docs](https://github.com/pirate/wireguard-docs) ⭐ 5,045 | 🐛 0 | 🌐 Shell | 📅 2026-03-21 - Unofficial WireGuard documentation.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 44,094 | 🐛 141 | 🌐 Go | 📅 2026-09-23 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 29,486 | 🐛 1,476 | 🌐 Go | 📅 2026-09-24 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,802 | 🐛 228 | 🌐 Go | 📅 2026-09-24 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [Kilo](https://github.com/squat/kilo) ⭐ 2,290 | 🐛 96 | 🌐 Go | 📅 2026-09-13 - Kilo is a multi-cloud network overlay built on WireGuard and designed for Kubernetes (k8s + wg = kg).
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,392 | 🐛 76 | 🌐 Python | 📅 2026-09-23 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,104 | 🐛 397 | 🌐 Elixir | 📅 2026-09-24 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,296 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,506 | 🐛 12 | 🌐 Go | 📅 2026-09-13 - Powered by gVisor TCP/IP stack.
...
* [wg-meshconf](https://github.com/k4yt3x/wg-meshconf) ⭐ 1,054 | 🐛 9 | 🌐 Python | 📅 2024-05-05 - WireGuard full mesh configuration generator.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,994 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-24 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [TunnlTo/desktop-app](https://github.com/TunnlTo/desktop-app) ⭐ 1,958 | 🐛 2 | 📅 2026-04-14 - TunnlTo is a lightweight, fast, Windows WireGuard VPN client built for split tunneling.
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,726 | 🐛 100 | 🌐 Vue | 📅 2026-09-07 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,724 | 🐛 29 | 🌐 Go | 📅 2026-09-18 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,596 | 🐛 155 | 🌐 Rust | 📅 2026-09-24
