...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 44,116 | 🐛 141 | 🌐 Go | 📅 2026-09-25 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 29,516 | 🐛 1,426 | 🌐 Go | 📅 2026-09-25 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,803 | 🐛 228 | 🌐 Go | 📅 2026-09-25 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,106 | 🐛 387 | 🌐 Elixir | 📅 2026-09-25 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,297 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 27,000 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-25 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,725 | 🐛 29 | 🌐 Go | 📅 2026-09-18 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,598 | 🐛 152 | 🌐 Rust | 📅 2026-09-25
