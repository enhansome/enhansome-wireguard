...
* [coder/wush](https://github.com/coder/wush) ⭐ 1,488 | 🐛 22 | 🌐 Go | 📅 2025-07-28 - Simplest and fastest way to transfer files between computers via WireGuard.
...
* [easy-wg-quick](https://github.com/burghardt/easy-wg-quick) ⭐ 1,119 | 🐛 0 | 🌐 Shell | 📅 2026-08-10 - Creates Wireguard configuration for hub and peers with ease.
...
* [sandialabs/wiretap](https://github.com/sandialabs/wiretap) ⭐ 1,108 | 🐛 14 | 🌐 Go | 📅 2026-07-30 - Wiretap is a transparent, VPN-like proxy server that tunnels traffic via WireGuard and requires no special privileges to run.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,428 | 🐛 149 | 🌐 Go | 📅 2026-08-29 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 28,799 | 🐛 1,580 | 🌐 Go | 📅 2026-09-01 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,770 | 🐛 223 | 🌐 Go | 📅 2026-09-01 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [innernet](https://github.com/tonarino/innernet) ⭐ 5,537 | 🐛 83 | 🌐 Rust | 📅 2026-07-28 - A private network system that uses WireGuard under the hood. It is similar in its goals to Slack's nebula or Tailscale.
...
* [Kilo](https://github.com/squat/kilo) ⭐ 2,284 | 🐛 96 | 🌐 Go | 📅 2026-08-26 - Kilo is a multi-cloud network overlay built on WireGuard and designed for Kubernetes (k8s + wg = kg).
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,364 | 🐛 75 | 🌐 Python | 📅 2026-08-26 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,047 | 🐛 399 | 🌐 Elixir | 📅 2026-09-01 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) ⭐ 687 | 🐛 27 | 🌐 Go | 📅 2026-08-19 - An all-in-one WireGuard VPN solution with a Web UI for connecting devices. This project aims to deliver a simple VPN solution for developers, homelab enthusiasts and anyone else feeling adventurous.
...
* [PiVPN](https://github.com/pivpn/pivpn) ⭐ 8,037 | 🐛 14 | 🌐 Shell | 📅 2026-08-30 - The Simplest VPN installer (scripts), designed for Raspberry Pi.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,469 | 🐛 16 | 🌐 Go | 📅 2026-08-08 - Powered by gVisor TCP/IP stack.
...
* [wg-meshconf](https://github.com/k4yt3x/wg-meshconf) ⭐ 1,051 | 🐛 9 | 🌐 Python | 📅 2024-05-05 - WireGuard full mesh configuration generator.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,826 | 🐛 46 | 🌐 TypeScript | 📅 2026-08-31 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [h44z/wg-portal](https://github.com/h44z/wg-portal) ⭐ 1,808 | 🐛 35 | 🌐 Go | 📅 2026-08-31 - Supports LDAP and more
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,707 | 🐛 99 | 🌐 Vue | 📅 2026-08-31 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,654 | 🐛 29 | 🌐 Go | 📅 2026-08-24 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,526 | 🐛 156 | 🌐 Rust | 📅 2026-09-01
