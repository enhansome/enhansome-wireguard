...
* [WireGuard Docs](https://github.com/pirate/wireguard-docs) ⭐ 5,043 | 🐛 0 | 🌐 Shell | 📅 2026-03-21 - Unofficial WireGuard documentation.
...
* [coder/wush](https://github.com/coder/wush) ⭐ 1,494 | 🐛 21 | 🌐 Go | 📅 2025-07-28 - Simplest and fastest way to transfer files between computers via WireGuard.
...
* [easy-wg-quick](https://github.com/burghardt/easy-wg-quick) ⭐ 1,117 | 🐛 1 | 🌐 Shell | 📅 2026-09-02 - Creates Wireguard configuration for hub and peers with ease.
...
* [sandialabs/wiretap](https://github.com/sandialabs/wiretap) ⭐ 1,113 | 🐛 12 | 🌐 Go | 📅 2026-09-08 - Wiretap is a transparent, VPN-like proxy server that tunnels traffic via WireGuard and requires no special privileges to run.
...
* [onetun](https://github.com/aramperes/onetun) ⭐ 1,039 | 🐛 17 | 🌐 Rust | 📅 2025-10-20 - A user-space WireGuard port-forwarder -- access ports running on peers in your WireGuard network from any device; without having to install WireGuard locally or without root access (no iptables configs).
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,884 | 🐛 149 | 🌐 Go | 📅 2026-09-15 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 29,279 | 🐛 1,518 | 🌐 Go | 📅 2026-09-16 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,786 | 🐛 226 | 🌐 Go | 📅 2026-09-16 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [innernet](https://github.com/tonarino/innernet) ⭐ 5,548 | 🐛 83 | 🌐 Rust | 📅 2026-07-28 - A private network system that uses WireGuard under the hood. It is similar in its goals to Slack's nebula or Tailscale.
...
* [Kilo](https://github.com/squat/kilo) ⭐ 2,285 | 🐛 96 | 🌐 Go | 📅 2026-09-13 - Kilo is a multi-cloud network overlay built on WireGuard and designed for Kubernetes (k8s + wg = kg).
...
* [wesher](https://github.com/costela/wesher) ⭐ 988 | 🐛 20 | 🌐 Go | 📅 2025-02-17 - wesher creates and manages an encrypted mesh overlay network across a group of nodes.
...
* [HarvsG/WireGuardMeshes](https://github.com/HarvsG/WireGuardMeshes) ⭐ 653 | 🐛 9 | 📅 2024-12-15 - Compare WireGuard mesh tools.
...
* [svenstaro/wiresmith](https://github.com/svenstaro/wiresmith) ⭐ 147 | 🐛 2 | 🌐 Rust | 📅 2026-09-01 - Auto-config WireGuard clients into a mesh ![GitHub last commit](https://img.shields.io/github/last-commit/svenstaro/wiresmith?style=flat-square\&color=informational) :green\_circle:
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,382 | 🐛 77 | 🌐 Python | 📅 2026-09-09 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,095 | 🐛 416 | 🌐 Elixir | 📅 2026-09-16 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [WireHole](https://github.com/IAmStoxe/wirehole) ⭐ 4,967 | 🐛 62 | 🌐 Shell | 📅 2026-08-25 - A combination of WireGuard, Pi-hole, and Unbound in a docker-compose project with the intent of enabling users to quickly and easily create a personally managed full or split-tunnel WireGuard VPN with ad blocking capabilities thanks to Pi-hole, and DNS caching, additional privacy options, and upstream providers via Unbound.
...
* [Cloudblock](https://github.com/chadgeary/cloudblock) ⭐ 859 | 🐛 2 | 🌐 HCL | 📅 2024-07-06 - Deploys WireGuard VPN, Pi-Hole DNS Ad-blocking, and DNS over HTTPS in a cloud provider - or locally - using Terraform and Ansible.
...
* [ansible-role-wireguard](https://github.com/githubixx/ansible-role-wireguard) ⭐ 696 | 🐛 22 | 🌐 Jinja | 📅 2026-06-15 - Ansible role for installing WireGuard VPN. Supports Ubuntu, Debian, Archlinx, Fedora and CentOS.
...
* [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) ⭐ 687 | 🐛 2 | 🌐 Go | 📅 2026-09-15 - An all-in-one WireGuard VPN solution with a Web UI for connecting devices. This project aims to deliver a simple VPN solution for developers, homelab enthusiasts and anyone else feeling adventurous.
...
* [linuxserver/docker-wireguard](https://github.com/linuxserver/docker-wireguard) ⭐ 3,635 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-10 - A WireGuard container image brought to you by LinuxServer.io. Not all image authors are as great as LinuxServer.io team.
...
* [masipcat/wireguard-go-docker](https://github.com/masipcat/wireguard-go-docker) ⭐ 208 | 🐛 6 | 🌐 Go | 📅 2026-03-21 - WireGuard docker image.
...
* [MindFlavor/prometheus\_wireguard\_exporter](https://github.com/MindFlavor/prometheus_wireguard_exporter) ⭐ 604 | 🐛 36 | 🌐 Rust | 📅 2023-10-24 - A Prometheus exporter for WireGuard, very light on your server resources.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,280 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [PiVPN](https://github.com/pivpn/pivpn) ⭐ 8,044 | 🐛 14 | 🌐 Shell | 📅 2026-08-30 - The Simplest VPN installer (scripts), designed for Raspberry Pi.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,497 | 🐛 13 | 🌐 Go | 📅 2026-09-13 - Powered by gVisor TCP/IP stack.
...
* [Nyr/wireguard-install](https://github.com/Nyr/wireguard-install) ⭐ 4,926 | 🐛 0 | 🌐 Shell | 📅 2026-07-02 - WireGuard road warrior installer for Ubuntu, Debian, CentOS and Fedora.
...
* [WireGuard-Manager](https://github.com/complexorganizations/wireguard-manager) ⭐ 1,856 | 🐛 34 | 🌐 Shell | 📅 2025-12-15 - enables you to build your own vpn under a minute.
...
* [wg-meshconf](https://github.com/k4yt3x/wg-meshconf) ⭐ 1,053 | 🐛 9 | 🌐 Python | 📅 2024-05-05 - WireGuard full mesh configuration generator.
...
* [AndrianBdn/wg-cmd](https://github.com/AndrianBdn/wg-cmd) ⭐ 224 | 🐛 2 | 🌐 Go | 📅 2026-07-07 - WG Commander is a TUI for a simple WireGuard VPN setup. UI, QR Codes, Setup Wizard in the terminal.
...
* [docker-wireguard-socks-proxy](https://github.com/kizzx2/docker-wireguard-socks-proxy) ⭐ 170 | 🐛 7 | 🌐 Dockerfile | 📅 2019-10-08 - Expose a WireGuard tunnel as a SOCKS5 proxy.
...
* [Wiresteward](https://github.com/utilitywarehouse/wiresteward) ⭐ 84 | 🐛 3 | 🌐 Go | 📅 2026-09-01 - A WireGuard peer manager with OAuth2 authentication.
...
* [b-m-f/wired](https://github.com/b-m-f/wired) ⭐ 17 | 🐛 1 | 🌐 Rust | 📅 2026-08-23 - WireGuard network configuration generator with support for multiple topologies written in Rust
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,943 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-16 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [wireguard-ui](https://github.com/ngoduykhanh/wireguard-ui) ⭐ 5,150 | 🐛 210 | 🌐 Go | 📅 2024-08-09 - Simple, have empty interfaces for authentication
...
* [h44z/wg-portal](https://github.com/h44z/wg-portal) ⭐ 1,817 | 🐛 24 | 🌐 Go | 📅 2026-09-13 - Supports LDAP and more
...
* [Subspace](https://github.com/subspacecommunity/subspace) ⭐ 1,806 | 🐛 65 | 🌐 HTML | 📅 2024-06-13 - A simple WireGuard VPN server GUI.
...
* [vx3r/wg-gen-web](https://github.com/vx3r/wg-gen-web) ⭐ 1,705 | 🐛 49 | 🌐 Go | 📅 2024-05-07 - Simple Web based configuration generator for WireGuard.
...
* [TunnlTo/desktop-app](https://github.com/TunnlTo/desktop-app) ⭐ 1,962 | 🐛 2 | 📅 2026-04-14 - TunnlTo is a lightweight, fast, Windows WireGuard VPN client built for split tunneling.
...
* [network-manager-wireguard](https://github.com/max-moser/network-manager-wireguard) ⭐ 467 | 🐛 45 | 🌐 C | 📅 2023-06-14 - Network-Manager VPN Plugin for WireGuard.
...
* [WireGuardStatusbar](https://github.com/aequitas/macos-menubar-wireguard) ⭐ 272 | 🐛 5 | 🌐 Swift | 📅 2025-05-12 - macOS menubar icon for WireGuard/wg-quick.
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,720 | 🐛 101 | 🌐 Vue | 📅 2026-09-07 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,706 | 🐛 30 | 🌐 Go | 📅 2026-08-24 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,570 | 🐛 163 | 🌐 Rust | 📅 2026-09-16
...
* [MozWire](https://github.com/NilsIrl/MozWire) ⭐ 633 | 🐛 14 | 🌐 Rust | 📅 2025-01-04 - An unofficial configuration manager giving Linux, macOS users (among others), access to Mozilla VPN.
...
* [wgsd](https://github.com/jwhited/wgsd) ⭐ 898 | 🐛 19 | 🌐 Go | 📅 2023-12-26 - A CoreDNS plugin that serves WireGuard peer information via DNS-SD (RFC6763) semantics. This enables use cases such as mesh networking, NAT-to-NAT connectivity, and dynamic discovery of WireGuard endpoint.
...
* [nr-wg-mtu-finder](https://github.com/nitred/nr-wg-mtu-finder) ⭐ 366 | 🐛 8 | 🌐 Python | 📅 2025-08-08 - A Python project to help you find the optimal MTU values for WG server and WG peer that maximizes the upload or download speeds between a peer and server.
...
* [boringtun](https://github.com/cloudflare/boringtun) ⭐ 7,195 | 🐛 109 | 🌐 Rust | 📅 2026-06-29 - Userspace WireGuard implementation in Rust by Cloudflare.
...
* [ciniml/WireGuard-ESP32-Arduino](https://github.com/ciniml/WireGuard-ESP32-Arduino) ⭐ 962 | 🐛 34 | 🌐 C | 📅 2024-04-01 - WireGuard implementation for ESP32 Arduino in C.
...
* [smartalock/wireguard-lwip](https://github.com/smartalock/wireguard-lwip) ⭐ 259 | 🐛 12 | 🌐 C | 📅 2026-08-14 - A C implementation of the WireGuard protocol intended to be used with the lwIP IP stack.
...
* [Routing Docker Host And Container Traffic Through WireGuard](https://www.linuxserver.io/blog/routing-docker-host-and-container-traffic-through-wireguard) using [WireGuard Docker image by linuxserver.io](https://github.com/linuxserver/docker-wireguard) ⭐ 3,635 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-10
* [Fly-Tailscale-Exit](https://github.com/patte/fly-tailscale-exit) ⭐ 1,661 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - Run your own VPN with global exit nodes with Fly.io, Tailscale and Github.
