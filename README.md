...
* [sandialabs/wiretap](https://github.com/sandialabs/wiretap) ⭐ 1,110 | 🐛 14 | 🌐 Go | 📅 2026-07-30 - Wiretap is a transparent, VPN-like proxy server that tunnels traffic via WireGuard and requires no special privileges to run.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,625 | 🐛 144 | 🌐 Go | 📅 2026-09-04 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 28,976 | 🐛 1,589 | 🌐 Go | 📅 2026-09-07 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,773 | 🐛 223 | 🌐 Go | 📅 2026-09-04 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,367 | 🐛 77 | 🌐 Python | 📅 2026-09-02 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,053 | 🐛 429 | 🌐 Elixir | 📅 2026-09-07 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) ⭐ 687 | 🐛 13 | 🌐 Go | 📅 2026-09-07 - An all-in-one WireGuard VPN solution with a Web UI for connecting devices. This project aims to deliver a simple VPN solution for developers, homelab enthusiasts and anyone else feeling adventurous.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,477 | 🐛 15 | 🌐 Go | 📅 2026-09-06 - Powered by gVisor TCP/IP stack.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,877 | 🐛 53 | 🌐 TypeScript | 📅 2026-09-07 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [TunnlTo/desktop-app](https://github.com/TunnlTo/desktop-app) ⭐ 1,967 | 🐛 2 | 📅 2026-04-14 - TunnlTo is a lightweight, fast, Windows WireGuard VPN client built for split tunneling.
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,710 | 🐛 99 | 🌐 Vue | 📅 2026-08-31 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,679 | 🐛 29 | 🌐 Go | 📅 2026-08-24 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,540 | 🐛 159 | 🌐 Rust | 📅 2026-09-07
