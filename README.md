...
* [coder/wush](https://github.com/coder/wush) ⭐ 1,493 | 🐛 21 | 🌐 Go | 📅 2025-07-28 - Simplest and fastest way to transfer files between computers via WireGuard.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,949 | 🐛 149 | 🌐 Go | 📅 2026-09-17 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 29,340 | 🐛 1,522 | 🌐 Go | 📅 2026-09-18 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,789 | 🐛 226 | 🌐 Go | 📅 2026-09-18 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [innernet](https://github.com/tonarino/innernet) ⭐ 5,550 | 🐛 83 | 🌐 Rust | 📅 2026-07-28 - A private network system that uses WireGuard under the hood. It is similar in its goals to Slack's nebula or Tailscale.
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,387 | 🐛 77 | 🌐 Python | 📅 2026-09-09 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,096 | 🐛 389 | 🌐 Elixir | 📅 2026-09-18 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [MindFlavor/prometheus\_wireguard\_exporter](https://github.com/MindFlavor/prometheus_wireguard_exporter) ⭐ 604 | 🐛 37 | 🌐 Rust | 📅 2023-10-24 - A Prometheus exporter for WireGuard, very light on your server resources.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,285 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [PiVPN](https://github.com/pivpn/pivpn) ⭐ 8,042 | 🐛 14 | 🌐 Shell | 📅 2026-08-30 - The Simplest VPN installer (scripts), designed for Raspberry Pi.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,500 | 🐛 12 | 🌐 Go | 📅 2026-09-13 - Powered by gVisor TCP/IP stack.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,961 | 🐛 55 | 🌐 TypeScript | 📅 2026-09-16 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,722 | 🐛 100 | 🌐 Vue | 📅 2026-09-07 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,710 | 🐛 30 | 🌐 Go | 📅 2026-08-24 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,577 | 🐛 158 | 🌐 Rust | 📅 2026-09-18
...
* [boringtun](https://github.com/cloudflare/boringtun) ⭐ 7,193 | 🐛 109 | 🌐 Rust | 📅 2026-06-29 - Userspace WireGuard implementation in Rust by Cloudflare.
