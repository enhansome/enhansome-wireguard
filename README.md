...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,129 | 🐛 155 | 🌐 Go | 📅 2026-07-30 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 28,620 | 🐛 1,575 | 🌐 Go | 📅 2026-08-24 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,039 | 🐛 407 | 🌐 Elixir | 📅 2026-08-24 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,243 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,738 | 🐛 43 | 🌐 TypeScript | 📅 2026-08-24 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [h44z/wg-portal](https://github.com/h44z/wg-portal) ⭐ 1,798 | 🐛 29 | 🌐 Go | 📅 2026-08-17 - Supports LDAP and more
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,699 | 🐛 97 | 🌐 Vue | 📅 2026-08-17 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,638 | 🐛 29 | 🌐 Go | 📅 2026-08-20 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,499 | 🐛 149 | 🌐 Rust | 📅 2026-08-24
