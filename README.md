...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 42,867 | 🐛 142 | 🌐 Go | 📅 2026-07-30 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 28,391 | 🐛 1,575 | 🌐 Go | 📅 2026-08-15 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,753 | 🐛 227 | 🌐 Go | 📅 2026-08-14 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,016 | 🐛 386 | 🌐 Elixir | 📅 2026-08-15 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,234 | 🐛 125 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,444 | 🐛 14 | 🌐 Go | 📅 2026-08-08 - Powered by gVisor TCP/IP stack.
...
* [Nyr/wireguard-install](https://github.com/Nyr/wireguard-install) ⭐ 4,919 | 🐛 0 | 🌐 Shell | 📅 2026-07-02 - WireGuard road warrior installer for Ubuntu, Debian, CentOS and Fedora.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,670 | 🐛 45 | 🌐 TypeScript | 📅 2026-08-14 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,696 | 🐛 98 | 🌐 Vue | 📅 2026-07-13 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,608 | 🐛 23 | 🌐 Go | 📅 2026-07-30 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,464 | 🐛 138 | 🌐 Rust | 📅 2026-08-15
...
* [boringtun](https://github.com/cloudflare/boringtun) ⭐ 7,166 | 🐛 107 | 🌐 Rust | 📅 2026-06-29 - Userspace WireGuard implementation in Rust by Cloudflare.
