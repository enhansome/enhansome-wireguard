...
* [coder/wush](https://github.com/coder/wush) ⭐ 1,455 | 🐛 22 | 🌐 Go | 📅 2025-07-28 - Simplest and fastest way to transfer files between computers via WireGuard.
...
* [sandialabs/wiretap](https://github.com/sandialabs/wiretap) ⭐ 1,104 | 🐛 12 | 🌐 Go | 📅 2026-07-30 - Wiretap is a transparent, VPN-like proxy server that tunnels traffic via WireGuard and requires no special privileges to run.
...
* [wgctrl](https://github.com/WireGuard/wgctrl-go) ⭐ 912 | 🐛 26 | 🌐 Go | 📅 2024-12-31 - Package wgctrl enables control of WireGuard interfaces on multiple platforms.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 42,809 | 🐛 141 | 🌐 Go | 📅 2026-07-30 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 28,333 | 🐛 1,567 | 🌐 Go | 📅 2026-08-12 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,749 | 🐛 227 | 🌐 Go | 📅 2026-08-12 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [innernet](https://github.com/tonarino/innernet) ⭐ 5,522 | 🐛 83 | 🌐 Rust | 📅 2026-07-28 - A private network system that uses WireGuard under the hood. It is similar in its goals to Slack's nebula or Tailscale.
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,358 | 🐛 77 | 🌐 Python | 📅 2026-08-12 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,013 | 🐛 382 | 🌐 Elixir | 📅 2026-08-13 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [WireHole](https://github.com/IAmStoxe/wirehole) ⭐ 4,965 | 🐛 59 | 📅 2026-01-29 - A combination of WireGuard, Pi-hole, and Unbound in a docker-compose project with the intent of enabling users to quickly and easily create a personally managed full or split-tunnel WireGuard VPN with ad blocking capabilities thanks to Pi-hole, and DNS caching, additional privacy options, and upstream providers via Unbound.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,232 | 🐛 125 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [PiVPN](https://github.com/pivpn/pivpn) ⭐ 8,032 | 🐛 14 | 🌐 Shell | 📅 2026-07-30 - The Simplest VPN installer (scripts), designed for Raspberry Pi.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,439 | 🐛 14 | 🌐 Go | 📅 2026-08-08 - Powered by gVisor TCP/IP stack.
...
* [Nyr/wireguard-install](https://github.com/Nyr/wireguard-install) ⭐ 4,918 | 🐛 0 | 🌐 Shell | 📅 2026-07-02 - WireGuard road warrior installer for Ubuntu, Debian, CentOS and Fedora.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,647 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-12 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [wireguard-ui](https://github.com/ngoduykhanh/wireguard-ui) ⭐ 5,140 | 🐛 210 | 🌐 Go | 📅 2024-08-09 - Simple, have empty interfaces for authentication
...
* [h44z/wg-portal](https://github.com/h44z/wg-portal) ⭐ 1,796 | 🐛 27 | 🌐 Go | 📅 2026-08-11 - Supports LDAP and more
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,694 | 🐛 97 | 🌐 Vue | 📅 2026-07-13 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,598 | 🐛 23 | 🌐 Go | 📅 2026-07-30 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,460 | 🐛 135 | 🌐 Rust | 📅 2026-08-13
...
* [boringtun](https://github.com/cloudflare/boringtun) ⭐ 7,165 | 🐛 107 | 🌐 Rust | 📅 2026-06-29 - Userspace WireGuard implementation in Rust by Cloudflare.
...
* [smartalock/wireguard-lwip](https://github.com/smartalock/wireguard-lwip) ⭐ 257 | 🐛 11 | 🌐 C | 📅 2026-04-16 - A C implementation of the WireGuard protocol intended to be used with the lwIP IP stack.
...
* [Fly-Tailscale-Exit](https://github.com/patte/fly-tailscale-exit) ⭐ 1,658 | 🐛 0 | 🌐 Shell | 📅 2026-08-09 - Run your own VPN with global exit nodes with Fly.io, Tailscale and Github.
