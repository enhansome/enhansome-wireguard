...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 44,142 | 🐛 138 | 🌐 Go | 📅 2026-09-26 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 29,535 | 🐛 1,412 | 🌐 Go | 📅 2026-09-26 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,802 | 🐛 230 | 🌐 Go | 📅 2026-09-26 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [Kilo](https://github.com/squat/kilo) ⭐ 2,292 | 🐛 97 | 🌐 Go | 📅 2026-09-13 - Kilo is a multi-cloud network overlay built on WireGuard and designed for Kubernetes (k8s + wg = kg).
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,394 | 🐛 77 | 🌐 Python | 📅 2026-09-23 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,106 | 🐛 383 | 🌐 Elixir | 📅 2026-09-26 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [freifunkMUC/wg-access-server](https://github.com/freifunkMUC/wg-access-server) ⭐ 688 | 🐛 0 | 🌐 Go | 📅 2026-09-26 - An all-in-one WireGuard VPN solution with a Web UI for connecting devices. This project aims to deliver a simple VPN solution for developers, homelab enthusiasts and anyone else feeling adventurous.
...
* [linuxserver/docker-wireguard](https://github.com/linuxserver/docker-wireguard) ⭐ 3,636 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-24 - A WireGuard container image brought to you by LinuxServer.io. Not all image authors are as great as LinuxServer.io team.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,299 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,507 | 🐛 12 | 🌐 Go | 📅 2026-09-13 - Powered by gVisor TCP/IP stack.
...
* [psyhomb/wireguard-tools](https://github.com/psyhomb/wireguard-tools) ⭐ 197 | 🐛 2 | 🌐 Shell | 📅 2026-09-25 - WireGuard helper scripts.
...
* [Wiresteward](https://github.com/utilitywarehouse/wiresteward) ⭐ 84 | 🐛 3 | 🌐 Go | 📅 2026-09-25 - A WireGuard peer manager with OAuth2 authentication.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 27,001 | 🐛 47 | 🌐 TypeScript | 📅 2026-09-25 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [h44z/wg-portal](https://github.com/h44z/wg-portal) ⭐ 1,824 | 🐛 26 | 🌐 Go | 📅 2026-09-21 - Supports LDAP and more
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,727 | 🐛 100 | 🌐 Vue | 📅 2026-09-07 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,728 | 🐛 29 | 🌐 Go | 📅 2026-09-18 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,600 | 🐛 153 | 🌐 Rust | 📅 2026-09-26
...
* [Routing Docker Host And Container Traffic Through WireGuard](https://www.linuxserver.io/blog/routing-docker-host-and-container-traffic-through-wireguard) using [WireGuard Docker image by linuxserver.io](https://github.com/linuxserver/docker-wireguard) ⭐ 3,636 | 🐛 3 | 🌐 Dockerfile | 📅 2026-09-24
