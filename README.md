...
* [sandialabs/wiretap](https://github.com/sandialabs/wiretap) ⭐ 1,106 | 🐛 12 | 🌐 Go | 📅 2026-07-30 - Wiretap is a transparent, VPN-like proxy server that tunnels traffic via WireGuard and requires no special privileges to run.
...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,098 | 🐛 152 | 🌐 Go | 📅 2026-07-30 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 28,593 | 🐛 1,581 | 🌐 Go | 📅 2026-08-23 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,039 | 🐛 420 | 🌐 Elixir | 📅 2026-08-23 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [angristan/WireGuard-install](https://github.com/angristan/wireguard-install) ⭐ 11,242 | 🐛 124 | 🌐 Shell | 📅 2026-05-02 - WireGuard VPN installer for Linux servers.
...
* [tun2socks](https://github.com/xjasonlyu/tun2socks) ⭐ 5,457 | 🐛 16 | 🌐 Go | 📅 2026-08-08 - Powered by gVisor TCP/IP stack.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,731 | 🐛 44 | 🌐 TypeScript | 📅 2026-08-19 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [wireguard-ui](https://github.com/ngoduykhanh/wireguard-ui) ⭐ 5,143 | 🐛 210 | 🌐 Go | 📅 2024-08-09 - Simple, have empty interfaces for authentication
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,639 | 🐛 29 | 🌐 Go | 📅 2026-08-20 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,494 | 🐛 151 | 🌐 Rust | 📅 2026-08-23
...
* [boringtun](https://github.com/cloudflare/boringtun) ⭐ 7,181 | 🐛 108 | 🌐 Rust | 📅 2026-06-29 - Userspace WireGuard implementation in Rust by Cloudflare.
