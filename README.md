...
* [Headscale](https://github.com/juanfont/headscale) ⭐ 43,803 | 🐛 143 | 🌐 Go | 📅 2026-09-10 - An open source implementation of the Tailscale control server.
...
* [NetBird](https://github.com/netbirdio/netbird) ⭐ 29,161 | 🐛 1,507 | 🌐 Go | 📅 2026-09-13 - (Previously Wiretrustee) NetBird is an open-source VPN management platform built on top of WireGuard® making it easy to create secure private networks for your organization or home. Technically, it creates an overlay network using ICE protocol (WebRTC) to negotiate P2P connections and WG (kernel module, when possible) to create a fast and encrypted tunnel between machines, falling back to relay (TURN) in case a P2P connection isn't possible. Pretty much just a client app is needed, the rest is done by the software. Their vision is to go beyond traditional VPN by bringing advanced NetSec (Zero Trust security model) like OpenZiti.
...
* [gravitl/netmaker](https://github.com/gravitl/netmaker) ⭐ 11,780 | 🐛 228 | 🌐 Go | 📅 2026-09-13 - Netmaker is a VPN platform that automates WireGuard from homelab to enterprise. The key distinctions in their solutions are: fast because it can use kernel WireGuard (instead of userspace WireGuard, which is slower), tailored towards the Cloud and Kubernetes, and fully self-hostable.
...
* [Algo VPN](https://github.com/trailofbits/algo) ⭐ 30,375 | 🐛 77 | 🌐 Python | 📅 2026-09-09 - Set up a DIY/personal VPN in the cloud. It is a set of Ansible scripts that simplify the setup of a personal WireGuard and IPsec VPN, open-sourced by Trail of Bits.
...
* [Firezone](https://github.com/firezone/firezone) ⭐ 9,089 | 🐛 429 | 🌐 Elixir | 📅 2026-09-13 - An open-source WireGuard-based VPN server alternative to OpenVPN Access Server. You can self-host this.
...
* [Nyr/wireguard-install](https://github.com/Nyr/wireguard-install) ⭐ 4,928 | 🐛 0 | 🌐 Shell | 📅 2026-07-02 - WireGuard road warrior installer for Ubuntu, Debian, CentOS and Fedora.
...
* [wg-easy/wg-easy](https://github.com/wg-easy/wg-easy) ⭐ 26,918 | 🐛 50 | 🌐 TypeScript | 📅 2026-09-09 - The easiest way to run WireGuard VPN + Web-based Admin UI.
...
* [h44z/wg-portal](https://github.com/h44z/wg-portal) ⭐ 1,814 | 🐛 26 | 🌐 Go | 📅 2026-09-12 - Supports LDAP and more
...
* [Wireguard Dashboard](https://github.com/donaldzou/wireguard-dashboard) ⭐ 3,715 | 🐛 101 | 🌐 Vue | 📅 2026-09-07 - A simple and easy to use WireGuard dashboard written in Python and Flask.
...
* [wgcf](https://github.com/ViRb3/wgcf) ⭐ 8,694 | 🐛 30 | 🌐 Go | 📅 2026-08-24 - Cross-platform, unofficial CLI for Cloudflare Warp.
...
* [Mullvad](https://github.com/mullvad/mullvadvpn-app) ⭐ 7,559 | 🐛 153 | 🌐 Rust | 📅 2026-09-13
...
* [Fly-Tailscale-Exit](https://github.com/patte/fly-tailscale-exit) ⭐ 1,659 | 🐛 0 | 🌐 Shell | 📅 2026-09-13 - Run your own VPN with global exit nodes with Fly.io, Tailscale and Github.
